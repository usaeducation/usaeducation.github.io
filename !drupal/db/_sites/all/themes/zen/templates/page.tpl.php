      ...
      <?php endif; ?>
         ...
         <?php if ($title): ?>
             <div class="title_line">
            	 <div class="title_line_center">
                      <h1 class="title"><?php print $title; ?></h1>
                      <p><?php if($language->language=='en') print t('Far East Business - is your guide to getting your children quality education in America!');
					  else print t('Компания "Far East Business" - это путь реального приобретения качественного образования Ваших детей в Америке. Обучение за рубежом - мечта, которую может исполнить Far East Business!'); ?></p>
                      <div class="clear"></div>
                  </div>
             </div>
        <?php endif; ?>	
